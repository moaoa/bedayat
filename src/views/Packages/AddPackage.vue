            ...
            <div class="">
              ...
              >
                ...
                <el-table-column :label="t('logo')"
                                 ...
                                 align="center">
                  <template #default="scope">
                    <img style="width: 50px; height: 50px;" :src="scope.row.logoPath != null ? scope.row.logoPath : 'https://img.freepik.com/free-vector/illustration-gallery-icon_53876-27002.jpg?w=826&t=st=1697042627~exp=1697043227~hmac=28c67bb898b511e9cc46c0a306217868065d8b33c354c0dfdeb945ee64e62e1d'">
                  </template>
                </el-table-column>
...
watch(()=> coursesStore.selectedGradeId, (val)=> coursesStore.loadCoursesToAddToPackage(""))
////////////////////validators
