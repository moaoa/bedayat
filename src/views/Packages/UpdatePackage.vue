        ...
        <div class="row">
          <div class="s">
            ...
            >
              ...
              <el-table-column :label="t('remove')" width="100" align="center">
                <template #default="scope">
                  <a
                    class="btn btn-icon btn-light-danger btn-sm"
...
import { PackageUpdateData, SelectCoursesDto } from "@/types/Packages/Packages";
...
const selectedPackageCourses = computed(
  () => coursesStore.selectedPackage?.courses
);
...
watch(
  ...
  (val) => (logoPath.value = val.logoPath!)
);
onMounted(() => {
