    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <div class="modal-content">
        <div class="modal-header" id="kt_modal_add_customer_header">
          <h2 class="fw-bolder">{{ $t("addAvatar") }}</h2>
          <div
...
const loading = computed(() => avatarStore.isCreatingNewItem);

const formRef = ref<null | HTMLFormElement>(null);

const modalRef = ref<null | HTMLElement>(null);

type FormData = { roleType: number | null; avatarPath: Blob | null };
...
const rules = ref<Record<keyof typeof formData, object[]>>({
  ...
  roleType: [{ required: false, message: t("required"), trigger: "blur" }],
});
