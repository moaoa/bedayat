    ...
    >
      ...
      >
        <el-table :data="tableData" class="table-responsive" max-width style="width: 100%" height="400">
          ...
          />
          <el-table-column
              prop="totalOfPurchases"
              :label="$t('totalOfPurchases')"
        ...
        <div class="grid row">
          <div class="col-9">
            ...
            <el-pagination
                ...
                :total="purchasedPackagesByUserStore.purchasedPackagesWithCount.length"
...
const purchasedPackagesByUserStore = usePurchasedPackagesWithCountStore();

const tableData = computed(
    () => purchasedPackagesByUserStore.purchasedPackagesWithCount as PurchasedPackageWithCount[]
);
...
const loadPackagesReport = () => {
  purchasedPackagesByUserStore.loadPurchasedPackagesWithCount({
