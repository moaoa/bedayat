    ...
    <div class="card-header border-0">
      ...
      <div class="card-toolbar">
        <button
          v-if="tabIndex == 1"
          type="button"
          class="btn btn-primary er fs-6 px-4 py-3"
        ...
        <div class="card-body" v-loading="SystemSettingsStore.dataLoading">
          <div class="tab-content pt-3" id="kt_tabs">
            ...
            >
              <!-- coin price  -->
              <div class="row mb-10">
                <label class="col-lg-2 col-form-label text-lg-end">{{
                  t("coinPrice")
                }}</label>
                <div class="col-lg-4 col-xl-3 col-6 mx-5">
                  <input
                    class="form-control form-control-solid"
                    :disabled="SystemSettingsStore.errorOccured"
                    type="number"
                    v-model="SystemSettingsStore.systemSettings.coinPrice"
                  />
                </div>
                <div class="col-lg-4 col-xl-4 col">
                  <button
                    :data-kt-indicator="
                      SystemSettingsStore.coindDataSubmitting ? 'on' : null
                    "
                    class="btn btn-sm btn-primary col-lg-4 col-xl-5 col-sm-4 col-7"
                    type="submit"
                    @click.prevent="
                      handleUpdate(SystemSettingType.CoinPrice, $event)
                    "
                  >
                    <span
                      v-if="!SystemSettingsStore.coindDataSubmitting"
              ...
              <div class="row mb-10">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3 col-3 mx-5">
                  ...
                  >
                    <el-date-picker
                      v-model="SystemSettingsStore.systemSettings.startOfYear"
                      style="width: 100%"
                      :disabled="SystemSettingsStore.errorOccured"
                      type="month"
                    >
                ...
                <div class="col-lg-4 col-xl-4 col">
                  <button
                    :data-kt-indicator="
                      SystemSettingsStore.startOfYearDataSubmitting
                        ? 'on'
                        : null
                    "
                    class="btn btn-sm btn-primary col-lg-4 col-xl-5 col-sm-4 col-7"
                    type="submit"
                    @click.prevent="
                      handleUpdate(SystemSettingType.StartDateOfSchool, $event)
                    "
                  >
                    <span
                      v-if="!SystemSettingsStore.startOfYearDataSubmitting"
                      class="indicator-label"
                    >
                      {{ $t("save") }}
                      <span class="svg-icon svg-icon-3 ms-2 me-0">
                    ...
                    <span
                      v-if="SystemSettingsStore.startOfYearDataSubmitting"
                      class="indicator-progress btn-sm"
                    >
                      {{ $t("pleaseWait") }}...
                      <span
                        class="spinner-border spinner-border-sm align-middle ms-2"
              ...
              <div class="row mb-10">
                <label class="col-lg-2 col-form-label text-lg-end"
                  >{{ t("endOfYearDate") }}:</label
                >
                <div class="col-sm-6 col-lg-4 col-xl-3 col-3 mx-5">
                  <el-form-item prop="name">
                    <el-date-picker
                      v-model="SystemSettingsStore.systemSettings.endOfYear"
                      style="width: 100%"
                      :disabled="SystemSettingsStore.errorOccured"
                      type="month"
                    >
                ...
                <div class="col-lg-4 col-xl-4 col">
                  <button
                    :data-kt-indicator="
                      SystemSettingsStore.endOfYearDataSubmitting ? 'on' : null
                    "
                    class="btn btn-sm btn-primary col-lg-4 col-xl-5 col-sm-4 col-7"
                    type="submit"
                    @click.prevent="
                      handleUpdate(SystemSettingType.EndDateOfSchool, $event)
                    "
                  >
                    <span
                      v-if="!SystemSettingsStore.endOfYearDataSubmitting"
                      class="indicator-label"
                    >
                      {{ $t("save") }}
                      <span class="svg-icon svg-icon-3 ms-2 me-0"> </span>
                    </span>
                    <span
                      v-if="SystemSettingsStore.endOfYearDataSubmitting"
                      class="indicator-progress"
            ...
            >
              <div class="card-body pt-2">
                <!-- begin::table -->
                <el-table
                  :data="SubscriptionSettingsStore.subscriptionSettings"
                  style="width: 100%"
                  height="500"
                >
                  <el-table-column
                  ...
                  <el-table-column
                    prop="period"
                    :label="$t('periodInDays')"
                    width="100"
                    align="center"
                    header-align="center"
                  />
                  <el-table-column
                    prop="periodArabicName"
                    :label="$t('arabicName')"
                    width="150"
                    align="center"
                    header-align="center"
              ...
              <UpdateSubscriptionSettingModal
                ref="updateSubscriptionSettingsModalRef"
              >
              </UpdateSubscriptionSettingModal>
...
const updateSubscriptionSettingsModalRef = ref<{
...
const refreshCard = async () => {
  ...
  if (tabIndex.value == 0) await SystemSettingsStore.getSettings();
...
const handleEdit = (index: number, row: SubscriptionSettings) => {
  SubscriptionSettingsStore.subsctiptionSettingToUpdate = { ...row };
};
const handleDelete = (index: number, row: SubscriptionSettings) => {
  // @ts-ignore
  SubscriptionSettingsStore.subsctiptionSettingToDelete = structuredClone({
    ...row,
  });
